...
against. See ``pacct/core/wordbits.py`` for the measured numbers.
...
from pacct.core.wordbits import KINDS, base_model, entry_from_profiles  # noqa: E402
from pacct.parsers import dnp_profile  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--out", type=Path, default=WORDBITS_DIR)
