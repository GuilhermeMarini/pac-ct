...
from pacct.core.mms_tables import fc_rank as _fc_rank  # noqa: E402
from pacct.parsers.scd import sel_da_fcs, sel_short_addresses  # noqa: E402
from pacct.paths import FIXTURES_DIR, MMS_MAP_DIR  # noqa: E402

CORPUS = {"411L", "451", "487E", "311C1", "751", "2414", "2440"}

# FC_PREFERENCE and its rank helper now live in pacct/core/mms_tables.py --
# the library side of the same data -- so this generator and
# pacct/web/glv/mms_map.py (the live-SCD resolver) import ONE definition
