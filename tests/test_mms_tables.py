...
def _load_generator():
    ...
    spec = importlib.util.spec_from_file_location(
        ...
        PROJECT_ROOT / "tools" / "mms_tables_from_wordbits.py",
    )
...
def test_no_bit_with_a_non_co_candidate_ends_up_on_a_co_item():
    ...
    from pacct.paths import FIXTURES_DIR

    src_path = FIXTURES_DIR / "ICD files" / "SEL" / "wordbits.json"
    if not src_path.exists():
        pytest.skip("fixtures/ICD files/SEL/wordbits.json indisponivel localmente")
...
class TestDaVocabulary:
    ...
    def test_status_beats_anything_else_beats_a_control(self):
        from pacct.core.mms_tables import da_rank
...
class TestParseSaddr:
    ...
    def test_a_plain_address_is_one_name_and_no_rule(self):
        from pacct.core.mms_tables import parse_saddr
...
class TestEnumStatusDas:
    ...
    def test_dirgeneral_is_readable_only_with_a_rule(self):
        from pacct.core.mms_tables import is_boolean_status, is_enum_status
    ...
    def test_a_float_or_a_control_is_not_an_enum_status_either(self):
        from pacct.core.mms_tables import is_enum_status
...
class TestTheShippedTablesStayLoadable:
    ...
    def test_every_shipped_row_is_two_or_three_elements(self):
        ...
        from pacct.paths import MMS_MAP_DIR
...
class TestOneBadFileCannotTakeTheRegistryDown:
    ...
    def _restore_registry(self):
        ...
        `monkeypatch` puts `MMS_MAP_DIR` back but knows nothing about the
        ...
        """
        from pacct.core import mms_tables as mt
    ...
    def _registry(self, tmp_path, monkeypatch, files):
        ...
        monkeypatch.setattr(mt, "MMS_MAP_DIR", tmp_path)
        mt.invalidate()
        return mt
