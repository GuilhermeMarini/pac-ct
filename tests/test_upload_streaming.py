...
from pacct.parsers import rdb, rdb_cache
...
def _ole(tmp_path: Path, marker: bytes = b"hello") -> bytes:
    ...
    ore.write_ole(path, [
        ore.Entry(name="Relays", is_storage=True, size=0, read=None, children=[
            ore.Entry(name="QPC1", is_storage=True, size=0, read=None, children=[
                ore.Entry(name="SET_1.TXT", is_storage=False, size=len(marker),
                          read=lambda: marker, children=[]),
                ore.Entry(name="Misc", is_storage=True, size=0, read=None,
                          children=[
                    ore.Entry(name="GL1.gle", is_storage=False, size=len(_GLE),
