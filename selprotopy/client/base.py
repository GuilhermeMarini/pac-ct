...
class SELClient():
    ...
    def quit(self):
        ...
        """
        # Em muitos terminal servers (SEL-3530, etc.) enviar QUIT no nivel 0
        # encerra a sessao TCP. Se ja estamos no nivel 0, nao ha o que sair.
        try:
            current_level, _ = self.access_level()
            if current_level == 0:
                return
        except Exception:
            pass
