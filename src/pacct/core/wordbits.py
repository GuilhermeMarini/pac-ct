...
* **The SEL DNP3 Device Profile** (``pacct.parsers.dnp_profile``, seeded by
...
from pacct.paths import WORDBITS_DIR
...
def invalidate() -> None:
    ...
    Importing a device profile writes a new file into ``WORDBITS_DIR`` while
