...
A saida deste modulo eh consumida pelo `pacct.web.settings_compare` (tool web)
...
from pacct.core import selogic_parser as sp
...
from pacct.parsers.sel_settings import (
    ParsedSettings,
